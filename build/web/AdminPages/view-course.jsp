                ...
                %>
                  ...
                  <tr>
                    ...
                    <td><%= bean.getCOURSE_NAME() %></td>
                     <td><%= bean.getCOURSE_IMAGE() %></td>
                    <td><%= bean.getAVRAGE_DURATION() %></td>
                    <td><%= bean.getAVRAGE_FEES() %></td>
                    <td><%= bean.getDETAIL() %></td>

                    <td><div class="btn-group" role="group" aria-label="Basic mixed styles example">
                            <a href="update-course.jsp?csId=<%= bean.getCOURSE_ID() %>"><button type="button" class="btn btn-warning">Update</button></a>
                            <a href="DeleteCourseSrv?csId=<%= bean.getCOURSE_ID() %>"><button type="button" class="btn btn-success">Delete</button></a>
                </div></td>
                  </tr>
